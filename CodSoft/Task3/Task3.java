...
class BankAccount{
    ...
    public void deposit(int a1){
        if (a1 > 0){
            balance += a1;
            System.out.println("Deposit of " + a1 + ".Rs was successfull");
        } else {
    ...
    public void withdraw(int a1){
        if (a1 > 0 && a1 <= balance){
            System.out.println("Withdraw successfull of Rs."+ a1 +"/-");
            balance -= a1;
        } else {
...
class Main{
    public static void main(String[] args) {
        Scanner sc = new Scanner(System.in);
        BankAccount acc = new BankAccount(1500000);
        ATM atm = new ATM(acc);
